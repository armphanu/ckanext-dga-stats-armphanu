...
class StatsController(BaseController):
    ...
    def index(self):
        ...
        c.activity_counts_year = self.timed(stats.activity_counts_year)
        c.activity_counts_month = self.timed(stats.activity_counts_month)
        c.activity_counts_day = self.timed(stats.activity_counts_day)
